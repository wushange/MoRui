...
public final class ApiModule_ProvideNoticeApiFactory implements Factory<NoticeApi> {
  ...
  public ApiModule_ProvideNoticeApiFactory(
      ApiModule module,
  ...
  public NoticeApi get() {
    return Preconditions.checkNotNull(
        module.provideNoticeApi(helperProvider.get(), okHttpClientProvider.get()),
        "Cannot return null from a non-@Nullable @Provides method");
  }

  public static Factory<NoticeApi> create(
      ApiModule module,
      Provider<RequestHelper> helperProvider,
      Provider<OkHttpClient.Builder> okHttpClientProvider) {
    return new ApiModule_ProvideNoticeApiFactory(module, helperProvider, okHttpClientProvider);
  }
}
